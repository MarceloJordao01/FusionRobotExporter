# -*- coding: utf-8 -*-
"""
Launch file templates for ROS2
...
def get_display_launch_text(package_name, robot_name):
    return DISPLAY_LAUNCH.format(package_name=package_name, robot_name=robot_name)


def get_gazebo_launch_text(package_name, robot_name):
    return GAZEBO_LAUNCH.format(package_name=package_name, robot_name=robot_name)
