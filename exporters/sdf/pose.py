# -*- coding: utf-8 -*-
"""
Pose utilities for SDF exporter
...
class Pose:
    def __init__(self, translation: List[float] = None, rotation: List[float] = None, relative_to='__model__'):
    ...
    def inverse(self):
        return Pose(
            self.transform.inverse().get_translation(),
            self.transform.inverse().get_rotation_rpy(),
            self.relative_to
        )
